...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-TIAMC1_MiSTer.git"
CORE_NAME=(TIAMC1)
...
UPSTREAM_CORE_NAME=(TIAMC1)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(tiamc1.qpf)
COMPILATION_OUTPUT=(output_files/tiamc1.rbf)
